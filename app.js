...
new Vue({
  ...
  data: {
      ...
      { id: 16, name: 'Daenerys Targaryen', avatar: 'https://tom.imgix.net/daenerystargaryen.jpg?w=300&h=300&fit=facearea&facepad=1.7&auto=format,compress&mask=ellipse&fm=png', reason: 'Stabbed to death by Jon Snow'}
      ]
  }
})
      /*jonName: 'Jon Snow', 
